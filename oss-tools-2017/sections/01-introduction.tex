...
compiling or running it. For example, these metrics provide information about % tirar o `For example,`?
...
In this context, we created a platform that brings and presents these results to % we create?
the end user, specially, by analyzing source code metric history during its
life cycle.
% mesma linha ou em outra?
