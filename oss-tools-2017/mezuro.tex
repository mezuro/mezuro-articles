...
metrics to use, and interpretation of measure results. Besides that, this
practice is still not common in developer environments. Another problem is the
lack of Free/Open Source (FOSS) tools that integrate metric collectors to
different programming languages.
  % Soluções propostas
In this work, we present Mezuro, a FOSS web-based platform to collaboratively
evaluate source code. The project provides ways to compare projects and share
...
programming languages, and, currently, allows analysis of source code writted
in C, C++, Java, Ruby, Python, and PHP.
  % Frase de impacto
...
Static source code metrics are measured extracted from code without compiling
